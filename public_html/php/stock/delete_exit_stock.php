<?php 
	...
	echo $id_user 					= addslashes($_SESSION["id_user_activo"]);
	echo $id_exit_product 			= addslashes($_REQUEST["id_exit_master"]);
	echo $id_exit_product_detalle 	= addslashes($_REQUEST["id_exit_detalle"]);	
	echo $stock 						= addslashes($_REQUEST["id_element"]);
	echo $nota 						= addslashes($_REQUEST["nota"]);
	$process 					= "delete";
