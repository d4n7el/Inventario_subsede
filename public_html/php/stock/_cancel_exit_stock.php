...
<form action="<?php $_SERVER['DOCUMENT_ROOT'] ?>/php/stock/delete_exit_stock.php" class="create_info">
	<div class="row">
		...
		<input type="" value="<?php echo $id_exit_master ?>" name="id_exit_master" required="" readonly="">
		<input type="" value="<?php echo $id_exit_detalle ?>" name="id_exit_detalle" required="" readonly="">
		<input type="" value="<?php echo $id_element ?>" name="id_element" required="" readonly="">
