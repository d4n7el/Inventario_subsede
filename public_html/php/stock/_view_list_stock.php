				...
				<section>
					<form action="<?php $_SERVER['DOCUMENT_ROOT'] ?>/php/stock/update_stock.php" class="update_info" accept-charset="utf-8">
						...
						<div class="input-field col s4">
					         ...
					         <input id="nombre_producto" type="text" class="validate editar_info" name="cellar" autocomplete="off" value="<?php echo $value['id_cellar'] ?>"  readonly="readonly">
					          <label for="nombre_producto" class="active">Id Bodega: </label>
					    </div>
