	...
	<section>
		<form action="<?php $_SERVER['DOCUMENT_ROOT'] ?>/php/users/update_user.php" class="update_info" accept-charset="utf-8">
			...
			<div class="input-field col s4">
	            ...
	            <input id="nombre_user" type="text" action_next="index_user" ruta="php/users/update_user.php" id_update="<?php $value['id_user'] ?>" class="validate editar_info" name="nombre" autocomplete="off" value="<?php echo $value['name_user'] ?>"  readonly="readonly">
	            <label for="nombre_user" class="active">Nombre cliente</label>
	        </div>	
	        <div class="input-field col s4">
	            <i class="material-icons prefix">account_circle</i>
	            <input id="apellido_user" type="text" action_next="index_user" ruta="php/users/update_user.php" id_update="<?php $value['id_user'] ?>" class="validate editar_info" name="apellido" autocomplete="off" value="<?php echo $value['last_name_user'] ?>" readonly="readonly" >
	            <label for="apellido_user" class="active">Apellido cliente</label>
	        </div>
	        <div class="input-field col s4 hide oculto">
	            <i class="material-icons prefix">credit_card</i>
	            <input id="cedula_user" type="text" action_next="index_user" ruta="php/users/update_user.php" id_update="<?php $value['id_user'] ?>" class="validate editar_info" name="cedula" autocomplete="off" value="<?php echo $value['cedula'] ?>" readonly="readonly" >
