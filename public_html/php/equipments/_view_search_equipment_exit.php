<div class="row">
	<div class="alternos col s12">
		<button type="" class="waves-effect col s4 flujo_alterno waves-light btn btn-success" ruta="../php/equipments/create_equipment.php" data-target="modal_center_two">Crea un equipo
