<?php 
	...
	$cantidad = $_REQUEST["a_1"];	$id_exit_master = $_REQUEST["id_exit_master"];
	$id_exit_detalle = $_REQUEST["id_exit_detalle"]; $id_element = $_REQUEST["id_element"];
?>
<form action="<?php $_SERVER['DOCUMENT_ROOT'] ?>/php/tools/delete_exit_tools.php" class="create_info">
	<div class="row">
		<h5 class="titulo color_letra_secundario col s6 center"> herramienta: <?php echo $herramientas ?> </h5>
