<div class="row" id="view_actions">
	<div class="alternos col s12 m4 l3">
		...
		if ($_SESSION["id_user_activo_role"] != 'E_1_S1' AND $_SESSION["id_user_activo_role"] != 'A1-_1B') { ?>
			<button type="" class="waves-effect col s12 flujo_alterno waves-light btn btn-success" ruta="../php/tools/create_tools.php" data-target="modal_center_two">Crear Herramienta
...
<div class="list_stock_exit col s12" id="next_view_actions">
	...
	if (count($retorno_tools) > 0) {  
		foreach ($retorno_tools as $key => $tool) {  ?>
			<div class="col s12 m3 l3" id="<?php echo $tool['id_tool']."_".$tool['quantity_available'] ?>" style="padding: 0px;">
	          	<div class="card">
