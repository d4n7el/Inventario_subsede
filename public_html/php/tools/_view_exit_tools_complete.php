	...
	<div id="area_impresion">
		<div class="row">
			...
			<div class="col s4">
				...
				<h5 class="titulo col s12 center color_letra_secundario"><?php echo $retorno_view_exit_tools[0]['name_receive']; ?></h5>
			</div>
		...
		foreach ($retorno_view_exit_tools as $key => $view) { ?>
			<div class="row content_impresion" >
				<div class="col s3">
					<h6 class="titulo primary_cell center col s12 <?php echo ($view['state'] == 1)? "color_letra_secundario" : "color_letra_danger" ?>"><?php echo $view['name_tools']; ?></h6>
				</div>
				<div class="col s2">
