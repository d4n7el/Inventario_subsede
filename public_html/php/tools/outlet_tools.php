<div class="row">
    <div class="formulario col m6 offset-m3">
			<div class="input-field col s12 m12">
	            ...
	            <label for="receive_user" class="">Identificacion de quien recibe</label>
	        </div>
	        ...
	        <div class="action col m12 center">
	        	<button class="waves-effect waves-light btn btn-primary" id="add_exit">
	        		<i class="material-icons left">near_me</i>Agregar
	        	</button>
	        </div>
	        <div class="input-field col s12 m12" id="view_add_exit" ruta="<?php $_SERVER['DOCUMENT_ROOT'] ?>/php/equipments/_view_exit.php">
