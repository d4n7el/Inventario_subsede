<div class="row">
	...
	<div class="input-field col s8 offset-s2" style="margin-top: 4em">
        ...
        <label for="cantidad" class="active">Cantidad disponible: <?php echo (isset($retorno_planta[0]['quantity'])) ? $retorno_planta[0]['quantity']." ".$retorno_planta[0]['prefix_measure'] : $retorno_planta[0]['amount']." ".$retorno_planta[0]['prefix_measure'] ?> </label>
    </div>
