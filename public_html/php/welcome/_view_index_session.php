	...
	<div class="col s3 menu">
	    <div class="col s12 targeta_inicio">
			<div class="card transparent ">
				<div class="card-content color_letra_primario">
					<div class="title" >
						<span class="card-title">Usuarios <i class="material-icons color_letra_primario right">account_circle</i></span>

					</div>
					<div class="content centrar" >
						<div class="izquierda col s6 centrar">
							<i class="material-icons color_letra_primario">account_circle</i>
						</div>
	    ...
	    <div class="col s12 targeta_inicio">
			<div class="card transparent ">
				<div class="card-content color_letra_primario">
					<div class="title" >
						<span class="card-title">Medidas<i class="material-icons color_letra_primario right">hourglass_empty</i></span>
					</div>
					<div class="content centrar" >
						<div class="izquierda col s6 centrar">
							<i class="material-icons color_letra_primario">hourglass_empty</i>
						</div>
						<div class="derecha col s6 centrar">
							10
						</div>
	    ...
	    <div class="col s12 targeta_inicio">
			<div class="card transparent ">
				<div class="card-content color_letra_primario">
					<div class="title" >
						<span class="card-title">Productos<i class="material-icons color_letra_primario right">shopping_cart</i></span>
					</div>
					<div class="content centrar" >
						<div class="izquierda col s6 centrar">
							<i class="material-icons color_letra_primario">shopping_cart</i>
						</div>
						<div class="derecha col s6 centrar">
							10
						</div>
	    ...
	    <div class="col s12 targeta_inicio">
			<div class="card transparent ">
				<div class="card-content color_letra_primario">
					<div class="title" >
						<span class="card-title">Stock<i class="material-icons color_letra_primario right">shopping_basket</i></span>
					</div>
					<div class="content centrar" >
						<div class="izquierda col s6 centrar">
							<i class="material-icons color_letra_primario">shopping_basket</i>
						</div>
						<div class="derecha col s6 centrar">
							10
						</div>
	    ...
	    <div class="col s12 targeta_inicio">
			<div class="card transparent ">
				<div class="card-content color_letra_primario">
					<div class="title" >
						<span class="card-title">Salida Productos<i class="material-icons color_letra_primario right">rv_hookup</i></span>
					</div>
					<div class="content centrar" >
						<div class="izquierda col s6 centrar">
							<i class="material-icons color_letra_primario">rv_hookup</i>
						</div>
						<div class="derecha col s6 centrar">
							10
						</div>
	    ...
	    <div class="col s12 targeta_inicio">
			<div class="card transparent ">
				<div class="card-content color_letra_primario">
					<div class="title" >
						<span class="card-title">Equipo<i class="material-icons color_letra_primario right">content_cut</i></span>
					</div>
					<div class="content  centrar" >
						<div class="izquierda col s6 centrar">
							<i class="material-icons color_letra_primario">content_cut</i>
						</div>
						<div class="derecha col s6 centrar">
							10
						</div>
	     ...
	     <div class="col s12 targeta_inicio">
			<div class="card transparent ">
				<div class="card-content color_letra_primario">
					<div class="title" >
						<span class="card-title">Salida Equipo<i class="material-icons color_letra_primario right">content_cut</i></span>
					</div>
					<div class="content  centrar" >
						<div class="izquierda col s6 centrar">
							<i class="material-icons color_letra_primario">content_cut</i>
...
>>>>>>> 5a6cf82d054503fc6f96f534dc8b60d13ee2a167
				</div>
			</div>
	    </div>
	    <div class="col s12 targeta_inicio">
			<div class="card transparent ">
				<div class="card-content color_letra_primario">
					<div class="title" >
						<span class="card-title">Herramientas<i class="material-icons color_letra_primario right">build</i></span>
					</div>
					<div class="content centrar" >
						<div class="izquierda col s6 centrar">
							<i class="material-icons color_letra_primario">build</i>
						</div>
						<div class="derecha col s6 centrar">
							10
						</div>
	    ...
	    <div class="col s12 targeta_inicio">
			<div class="card transparent ">
				<div class="card-content color_letra_primario">
					<div class="title" >
						<span class="card-title">Salida herramienta<i class="material-icons color_letra_primario right">rv_hookup</i></span>
					</div>
					<div class="content centrar" >
						<div class="izquierda col s6 centrar">
							<i class="material-icons color_letra_primario">rv_hookup</i>
